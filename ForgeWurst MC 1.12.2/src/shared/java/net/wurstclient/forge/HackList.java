...
public final class HackList extends WHackList
{
	...
	public final ColorifyChatHack colorifyChatHack = register(new ColorifyChatHack());
	...
	public void loadEnabledHacks()
	{
		...
		{
			System.out
				.println("加载失败: " + enabledHacksFile.getFileName());
			e.printStackTrace();
	...
	public void saveEnabledHacks()
	{
		...
		{
			System.out
				.println("保存失败: " + enabledHacksFile.getFileName());
			e.printStackTrace();
		}
	}
	...
	public void loadSettings()
	{
		...
		{
			System.out.println("加载失败: " + settingsFile.getFileName());
			e.printStackTrace();
	...
	public void saveSettings()
	{
		...
		{
			System.out.println("保存失败: " + settingsFile.getFileName());
			e.printStackTrace();
		}
	}
}
