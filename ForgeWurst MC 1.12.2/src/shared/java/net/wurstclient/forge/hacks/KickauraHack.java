...
public final class KickauraHack extends Hack {
	...
	private final SliderSetting filterFlying = new SliderSetting("过滤飞行玩家",
	"不攻击离地一定距离的玩家.",
	0, 0, 2, 0.05,
	v -> v == 0 ? "关闭" : ValueDisplay.DECIMAL.getValueString(v));

	private final CheckboxSetting filterInvisible = new CheckboxSetting(
			"过滤不可见玩家", "不攻击隐身的实体.", false);
	...
	public void onUpdate(WUpdateEvent event) {
        ...
        private string playerID = target.getUniqueID().toString()

        CPacketChatMessage packet = new CPacketChatMessage("/kick " + playerID);
