...
public final class NukerHack extends Hack {
	private final SliderSetting range = new SliderSetting("范围", 5, 1, 6, 0.05, ValueDisplay.DECIMAL);
	private final EnumSetting<Mode> mode = new EnumSetting<>("模式", Mode.values(), Mode.NORMAL);
	...
	private enum Mode {
		NORMAL("正常", n -> n.getName(), (n, p) -> true),
